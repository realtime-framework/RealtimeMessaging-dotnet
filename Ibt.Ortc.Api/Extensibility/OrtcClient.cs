...
namespace Ibt.Ortc.Api.Extensibility
{
    ...
    public abstract class OrtcClient
    {
        ...
        ///   </code>
        ///   </example>
        public virtual void Connect(string applicationKey, string authenticationToken)
        {
        ...
        ///   </code>
        ///   </example>
        public virtual void Send(string channel, string message)
        {
            throw new NotImplementedException();
        }
        ...
        /// </summary>
        public virtual event OnConnectedDelegate OnConnected;

        /// <summary>
        /// Occurs when the client connection terminated. 
        /// </summary>
        public virtual event OnDisconnectedDelegate OnDisconnected;

        /// <summary>
        /// Occurs when the client subscribed to a channel.
        /// </summary>
        public virtual event OnSubscribedDelegate OnSubscribed;

        /// <summary>
        /// Occurs when the client unsubscribed from a channel.
        /// </summary>
        public virtual event OnUnsubscribedDelegate OnUnsubscribed;

        /// <summary>
        /// Occurs when there is an error.
        /// </summary>
        public virtual event OnExceptionDelegate OnException;

        /// <summary>
        /// Occurs when a client attempts to reconnect.
        /// </summary>
        public virtual event OnReconnectingDelegate OnReconnecting;

        /// <summary>
        /// Occurs when a client reconnected.
        /// </summary>
        public virtual event OnReconnectedDelegate OnReconnected;
